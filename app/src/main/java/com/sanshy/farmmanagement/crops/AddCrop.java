...
public class AddCrop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            PAll = findViewById(R.id.add_crop_exist_contatner);
        ...
        cropType.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    setSnipper(AddCrop.this,CropType,CropTypeHintList);
                }
            }
        ...
        partnerList.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    setSnipper(AddCrop.this,PartnerName2,PartnerList);
                    setSnipper(AddCrop.this,PartnerName1,PartnerList);
                    setSnipper(AddCrop.this,PartnerName3,PartnerList);
                    setSnipper(AddCrop.this,PartnerName4,PartnerList);
                    setSnipper(AddCrop.this,PartnerName5,PartnerList);
                }
            }
        ...
        builder.setTitle(getString(R.string.number_of_partners))
                .setSingleChoiceItems(pCount, 5, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(AddCrop.this, getString(R.string.partner)+" = "+pCount[which], Toast.LENGTH_SHORT).show();
...
//                        pC = Integer.parseInt(pCount[which]);
    ...
    public void AddCropBt(View view){
        ...
        CropId = NameString+"_"+YearOfSowingString+"_"+YearOfReapingString+"_"+LandOfAreaString+"_"+pC+"_"+TimeStampKey(new Date());
        ...
        singleCropLocation.document(CropId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if (documentSnapshot.exists()){
                    ShowDialog(AddCrop.this,getString(R.string.same_already_defined));
                }else{
                    SaveToCloud();
                }
            }
        ...
        singleCropLocation.document(CropId).set(SaveItem).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ShowDialog(AddCrop.this,getString(R.string.saved));
                }
                else{
                    ShowDialog(AddCrop.this,getString(R.string.try_again_later_or_send_feedback));
                }
            }
        });
