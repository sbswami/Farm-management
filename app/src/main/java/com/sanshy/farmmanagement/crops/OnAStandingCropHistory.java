...
public class OnAStandingCropHistory extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HistoryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(OnAStandingCropHistory.this);

                LayoutInflater inflater = (LayoutInflater) OnAStandingCropHistory.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                builder.setView(myView)
                        .setPositiveButton(OnAStandingCropHistory.this.getString(R.string.ok), null);

                builder.setNegativeButton(OnAStandingCropHistory.this.getString(R.string.undo), new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void FilterOnAStandingHistory(View v){
        ...
        SingleChooseDateFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                singleChooseDate = ChooseDateDialogSingle(OnAStandingCropHistory.this,SingleShowDateFilter);
            }
        });
        ...
        FromChooseDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fromChooseDate = ChooseDateDialogFrom(OnAStandingCropHistory.this,FromShowDate);
            }
        });
        ...
        ToChooseDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toChooseDate = ChooseDateDialogTo(OnAStandingCropHistory.this,ToShowDate);
            }
        });
    ...
    public void onWrongValue(){
        ShowDialog(OnAStandingCropHistory.this,getString(R.string.please_fill_correct_value));
    }

    public void dateWithAPro(QuerySnapshot queryDocumentSnapshots, Date date1, Date date2){
        OnAStandingList.clear();
        FourList.clear();
