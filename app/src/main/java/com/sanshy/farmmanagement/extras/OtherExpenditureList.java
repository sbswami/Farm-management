...
public class OtherExpenditureList extends AppCompatActivity {
    ...
    private void AddData() {
        ShowProgress(this);
        otherExpLocation.orderBy(MyStatic.DATE_SIDE_BUSINESS_KEY, Query.Direction.DESCENDING).get().addOnSuccessListener(myListener);
    }
    ...
    public void FilterOtherExpenditureHistory(View view){
        ...
        SingleChooseDateFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                singleChoose.add(0,ChooseDateDialogSingle(OtherExpenditureList.this,SingleShowDateFilter));
            }
        });
        ...
        FromChooseDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fromChoose.add(0,ChooseDateDialogFrom(OtherExpenditureList.this,FromShowDate));
            }
        });
        ...
        ToChooseDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toChoose.add(0,ChooseDateDialogTo(OtherExpenditureList.this,ToShowDate));
            }
        });
