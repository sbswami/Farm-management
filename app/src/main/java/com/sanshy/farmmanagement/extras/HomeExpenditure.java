...
public class HomeExpenditure extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_expenditure);

        Amount = findViewById(R.id.home_expenditure_amount);
        Remark = findViewById(R.id.home_expenditure_remark);
        ...
        HomeExpRemark.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    setSnipper(HomeExpenditure.this,Remark,RemarkList);
                }
            }
    ...
    public void HistoryBt(View view){
        startActivity(new Intent(this,HomeExpenditureList.class));
    }
    ...
    public void SaveBt(View view){
        ...
        if (!RemarkList.contains(RemarkString)){
            ...
            HomeExpRemark.setValue(RemarkList);
        }
        SaveIt();
    ...
    private void SaveIt() {
        ...
        homeExpLocation.document(Id).set(SaveItem).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ShowDialog(HomeExpenditure.this,getString(R.string.saved));
                    Remark.setText("");
                    Amount.setText("");
                }
                else{
                    ShowDialog(HomeExpenditure.this,getString(R.string.try_again_later_or_send_feedback));
                }
                HideProgress();
            }
        });
